...
__declspec(thread) PBYTE SetImageBase;
...

{
	...
	ImageBase = (PUCHAR)SetImageBase;
	NtHeaders = (PIMAGE_NT_HEADERS)(ImageBase + ((IMAGE_DOS_HEADER*)SetImageBase)->e_lfanew);
...
PiddFromDllName(LPCSTR szDll)
{
	...
	PIMAGE_NT_HEADERS   pinh = PinhFromImageBase(HMODULE(SetImageBase));
